	...
	<div class="container">
		<div style="text-align: center;">
			...
			<div class="row">
				...
				<p>
					<b>Referrals available in this database </b>
				</p>

				<table style="width: 100%">
					<tr>
						<th>Patient Reference No</th>
						<th>Referrer Type</th>
						<th>Patient Name</th>
						<th>Patient DOB</th>
						<th>Patient MOB</th>
					...
					<c:forEach items="${referals}" var="referal">


						<tr>
							<td><c:out value="${referal.getPatientRefNo()}" /></td>
							<td><c:out value="${referal.getReferer_type()}" /></td>
							<td><c:out value="${referal.getPatient_name()}" /></td>
							<td><c:out value="${referal.getPatient_dob()}" /></td>
							<td><c:out value="${referal.getPatient_mob()}" /></td>
							<td><c:out value="${referal.getEmail_id()}" /></td>
							<td><c:out value="${referal.getReferer_name()}" /></td>
							<td><c:out value="${referal.getReferer_mob()}" /></td>
							<td><c:out value="${referal.getReferer_email()}" /></td>
							<td><c:out value="${referal.getReferer_address()}" /></td>
						</tr>
		...
		<div class="copyrights">
			<div class="grid-row">
				...
				<div class="grid-col grid-col-6">
					Designed &amp; Developed by <a target="-blank"
						style="text-decoration: none;"/"><span
						style="color: #a4d845; font-weight: bold; font-size: 12px;">
							Praveen and</span><span
						style="color: #a4d845; font-weight: bold; font-size: 12px;">
							Team</span></a>
				</div>
			</div>
