...
<div class="container">
	...
	<div class="row">
	  <div class="col-sm-6">
<h4><b>Billing Details for services offered</b></h4>
	...
	<table style="width: 100%">
					...
					<c:forEach items="${billings}" var="billing">
						...
						<tr>
							<td><c:out value="${billing.getSno()}" /></td>
							<td><c:out value="${billing.getServiceOffered()}" /></td>
							<td><c:out value="${billing.getPrice()}" /></td>
