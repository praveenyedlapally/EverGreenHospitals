...
<body>
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="https://www.biovoicenews.com/wp-content/uploads/2016/11/Hospital.jpg" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="https://www.biovoicenews.com/wp-content/uploads/2016/11/Hospital.jpg" alt="Chicago">
    </div>

    <div class="item">
      <img src="https://www.biovoicenews.com/wp-content/uploads/2016/11/Hospital.jpg" alt="New York">
    </div>
  </div>
...
<div class="container">
	...
	<div class="row">
	  ...
	  <!-- ********************************************************************************************** -->
	  <!-- Appoint id value-->
	      <p><b>Doctors available in this department </b></p>
			...
			<table style="width: 100%">
				...
				<c:forEach items="${doctorsInfo}" var="doctorsInfo">
                         

				 	<tr>
						<td><c:out value="${doctorsInfo.getDoctorName()}" /></td>
						<td><c:out value="${doctorsInfo.getQualification()}" /></td>
						<td><c:out value="${doctorsInfo.getExperience()}" /></td>
						<td><c:out value="${doctorsInfo.getLocation()}" /></td>
