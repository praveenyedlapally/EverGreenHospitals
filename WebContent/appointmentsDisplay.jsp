	...
	<div class="container">
		<div style="text-align: center;">
			...
			<div class="row">
				...
				<p>
					<b>Appoinments available in this department </b> 
				...
				<table style="width: 100%">
					...
					<c:forEach items="${appointments}" var="appointment">
						...
						<tr>
							...
							<td><c:out value="${appointment.getFirstName()}" /></td>
							<td><c:out value="${appointment.getLastName()}" /></td>
							<td><c:out value="${appointment.getSex()}" /></td>
							<td><c:out value="${appointment.getContactNo()}" /></td>
							<td><c:out value="${appointment.getEmail()}" /></td>
							<td><c:out value="${appointment.getDate()}" /></td>
							<td><c:out value="${appointment.getLocation()}" /></td>
                            <td><c:out value="${appointment. getDepartment()}" /></td>
							<td><c:out value="${appointment.getDoctor()}" /></td>
						</tr>
