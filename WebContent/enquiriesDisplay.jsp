	...
	<div class="container">
		<div style="text-align: center;">
			...
			<div class="row">
				...
				<p>
					<b>Enquiries available in this database </b>
				</p>
				...
				<table style="width: 100%">
					...
					<c:forEach items="${enquires}" var="enquire">


						<tr>
							<td><c:out value="${enquire.getName()}" /></td>
							<td><c:out value="${enquire.getEmail()}" /></td>
							<td><c:out value="${enquire.getContactNo()}" /></td>
							<td><c:out value="${enquire.getCountry()}" /></td>
							<td><c:out value="${enquire.getState()}" /></td>
							<td><c:out value="${enquire.getCity()}" /></td>
							<td><c:out value="${enquire.getSpeciality()}" /></td>
							<td><c:out value="${enquire.getComments()}" /></td>
						</tr>
