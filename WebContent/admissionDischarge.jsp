...
<ul>
   <li>Patients are asked for to contact the confirmation counter and give them the points of interest e.g. Date of Admission, Treating specialist, and Preference class of settlement. </li>

   <li>Patients need the reference letter of the specialist or CMO's suggestion letter to encourage a confirmation.</li> 

<li>Pregnant patients are asked for to enlist something like 60 days before the normal date of conveyance. Typical conveyance cases are asked for to pay store sum.</li> 

<li>We will call you to affirm your confirmation upon the arrival of affirmation. On the date of affirmation a hint call will be put forth and in defense it isn't gotten you are asked for to affirm with the confirmation counter. </li>

<li>We acknowledge money/DD or check cards/Credit cards of every significant bank.</li>
</ul>
<h4><b>Discharge Information</b></h4>
<ul>
    <li>At KIMS, your specialist will compose a release arrange and illuminate you when you are prepared to leave the healing facility.</li> 

<li>It would take somewhere around 2 hours for the different release conventions to be finished. When the bill is prepared, the charging division will call you in your room. You are sympathetically asked for to hold up in your room till at that point.</li> 

<li>The nursing station, on creating the release approval slip, will give all reports and different archives to you; and kindly bear in mind to sign in the enlist that you have gathered every single essential report from nursing station.</li> 

<li>If it's not too much trouble abstain from opening windows in all rooms. It is risky and influences the cooling of the room.</li> 

<li>Patient's relatives are asked for not to tip the staff.</li>
</ul>
